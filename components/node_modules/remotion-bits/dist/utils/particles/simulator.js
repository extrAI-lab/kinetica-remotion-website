...
import { movement } from "./behaviors.js";
/**
 ...
 */
export function simulateParticles({ frame, fps, spawners, behaviors, }) {
    ...
    for (const spawner of spawners) {
        ...
        let totalBorn = 0;
        let birthFn; // Returns birth frame for index I
        ...
        for (let i = totalBorn - 1; i >= 0; i--) {
            ...
            if (age < 0)
                continue; // Should not happen with current logic but safe guard
            // ----------------------------------------------------------------------
