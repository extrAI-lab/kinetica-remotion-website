 ...
 */
export const createDrag = (factor, variance) => {
    if (!variance) {
 ...
 */
export const createWiggle = (magnitude, frequency = 0.5, magnitudeVariance) => {
    ...
    const perParticleMagnitude = new Map();
    return (p, age) => {
 ...
 */
export const createOpacityOverLife = (keyframes, startVariance, endVariance) => {
    ...
    const perParticleKeyframes = new Map();
    return (p, age) => {
 ...
 */
export const createScaleOverLife = (start, end, startVariance, endVariance) => {
    if (!startVariance && !endVariance) {
        // Fast path: no variance
        return (p, age) => {
            const lifeProgress = age / p.lifespan;
    ...
    const perParticleScale = new Map();
    return (p, age) => {
