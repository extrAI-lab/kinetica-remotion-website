...
export const MatrixRain = ({ fontSize = 20, color = '#00FF00', speed = 1, density = 1, streamLength = 20, charset = DEFAULT_CHARSET, }) => {
    ...
    return (_jsx(AbsoluteFill, { style: {
            ...
            lineHeight: 1,
            overflow: 'hidden',
        }, children: streams.map((stream, colIndex) => {
            if (!stream.isVisible)
                return null;
            ...
            return _jsx(React.Fragment, { children: chars }, colIndex);
        }) }));
};
//# sourceMappingURL=MatrixRain.js.map