...
export function lerpVector3(v1, v2, alpha) {
    return v1.clone().lerp(v2, alpha);
}
export function slerpQuaternion(q1, q2, alpha) {
    return q1.clone().slerp(q2, alpha);
}
export function interpolateTransform(from, to, progress, easing) {
    const t = easing ? easing(progress) : progress;
    return from.lerp(to, t);
}
export function interpolateMatrix4(from, to, progress) {
...
export function interpolateTransformKeyframes(keyframes, progress, easing) {
...
//# sourceMappingURL=interpolate3d.js.map