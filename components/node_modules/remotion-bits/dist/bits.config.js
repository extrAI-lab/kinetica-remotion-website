...
// HOOKS
// ============================================================================
export const use_viewport_rect = {
...
export const particles_utilities = {
 ...
 * Get a bit by its ID
 */
export function getBitById(id) {
    return bits[id];
}
/**
 * Get a bit by its registry name
 */
export function getBitByRegistryName(name) {
    return Object.values(bits).find(bit => bit.registryName === name);
}
/**
 * Get all bits in a category
 */
export function getBitsByCategory(category) {
...
export function getAllComponents() {
    return Object.values(bits).filter(bit => bit.category !== 'utilities' && bit.category !== 'hooks');
}
/**
 * Get all utilities
 */
 ...
 */
export function getBitExamples(bitId) {
 ...
 * Get bits by tag
 */
export function getBitsByTag(tag) {
    return Object.values(bits).filter(bit => bit.tags.includes(tag));
}
//# sourceMappingURL=bits.config.js.map