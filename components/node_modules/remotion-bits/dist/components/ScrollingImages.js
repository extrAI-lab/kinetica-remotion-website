...
import { useViewportRect } from "../hooks/useViewportRect.js";
export const ScrollingColumns = ({ columns, height = 300, width = "100%", gap = 20, columnGap = 20, className, style, imageStyle, }) => {
    ...
    return (_jsx("div", { className: className, style: {
            ...
            const numericImageHeight = typeof height === "number" ? height : parseInt(height) || 300;
            ...
            return (_jsx("div", { style: {
                    ...
                    }, children: copies.map((_, copyIndex) => (_jsx("div", { style: { display: 'flex', flexDirection: 'column', gap }, children: col.images.map((img, imgIndex) => (_jsx("div", { style: {
                                height: numericImageHeight,
                                width: "100%",
                                overflow: "hidden",
                                borderRadius: 8, // Optional, make it nice
                                ...imageStyle,
                            }, children: _jsx("img", { src: img, alt: "", style: {
                                    width: "100%",
                                    height: "100%",
                                    objectFit: "cover",
                                } }) }, `${copyIndex}-${imgIndex}`))) }, copyIndex))) }) }, colIndex));
        }) }));
};
//# sourceMappingURL=ScrollingImages.js.map