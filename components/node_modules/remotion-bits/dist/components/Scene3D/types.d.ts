...
export type TransitionConfig = TransformProps & VisualProps & TimingProps & {
    stagger?: number;
...
export type StepResponsiveMap = Record<StepReference | StepRange, StepResponsiveTransform> | StepResponsiveTransform[];
